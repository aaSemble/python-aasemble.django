...
class MirrorSetSerializer(serializers.HyperlinkedModelSerializer):
    mirrors = MirrorField(many=True, view_name='mirror-detail', queryset=mirrorsvc_models.Mirror.objects.all())
...
class PackageSourceSerializer(serializers.HyperlinkedModelSerializer):
    ...
    repository = RepositoryField(view_name='repository-detail', source='series.repository', queryset=buildsvc_models.Repository.objects.all())
...
class ExternalDependencySerializer(serializers.HyperlinkedModelSerializer):
    repository = RepositoryField(view_name='repository-detail', source='own_series.repository', queryset=buildsvc_models.Repository.objects.all())
